        ...
        for cid in clusters:
            ...
            if len(L_cols) >= 1:
                ...
                if resL is None:
                    ...
                    runlog.append({"cluster": cid, "block": "L", "status": "done", "n_rows": n_rows, "n_D": len(D_L), "n_X": len(X_L)})
            ...
            if len(E_cols) >= 1:
                ...
                if len(D_E) >= 1:
                    ...
                    if resE is None:
                        ...
                        runlog.append({"cluster": cid, "block": "E", "status": "done", "n_rows": n_rows, "n_D": len(D_E), "n_X": len(X_E)})
                else:
