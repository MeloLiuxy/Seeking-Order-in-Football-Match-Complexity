# -*- coding: utf-8 -*-
"""
Pass · All single-stage-passed KPI rotating joint interaction DML · L and E' separately
===========================================================================
...
INPUT_PATH = r"D:\pipeline\返修\聚类\传球cluster_sensitivity_K2_K5_仅修复end_location\Pass_K3_main_for_DML_仅修复end_location.csv"
SHEET_NAME = 0
OUTPUT_XLSX = r"D:\pipeline\返修\DML部分\pass_dml_固定代表KPI_联合交互DML_审稿人最终报告.xlsx"
...
# The former Pass Model A is retained as the prespecified anchor combination.
...
def joint_main():
    ...
    print("=" * 110)
    print("PASS · PASS-STYLE ROTATING JOINT DML · L AND E' SEPARATELY")
    print(f"Input : {INPUT_PATH}")
    print(f"Output: {OUTPUT_XLSX}")
    print("=" * 110)
...
INTERACTION_OUTPUT_XLSX = (
    r"D:\pipeline\返修\DML部分\pass_dml_固定代表KPI_联合交互DML_审稿人最终报告.xlsx"
)
