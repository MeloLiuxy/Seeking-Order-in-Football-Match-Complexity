# -*- coding: utf-8 -*-
"""
Pass · Single-KPI DML · L and E' · full reviewer sensitivity design
==================================================================

Main design
-----------
The Pass L and E' stages are analysed separately.
...
contain valid E' KPI columns calculated around the Pass end location using the
L-time freeze frame.
...
RAW_OR_POST_EVENT_PATTERNS = [
    r"^id$", r"^type$", r"^pass$", r"freeze_frame", r"back_ff",
...
def main():
    ...
    print("=" * 100)
    print("PASS · SINGLE-KPI DML · L AND E' · RF+RF PRIMARY + TRAINING-FOLD UNDERSAMPLING SENSITIVITY")
