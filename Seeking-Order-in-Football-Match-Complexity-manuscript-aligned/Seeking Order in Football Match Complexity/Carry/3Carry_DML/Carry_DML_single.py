...
def ovb_adjusted_statistics(
    ...
    Because the main manuscript inference uses HC3 heteroskedasticity-robust standard errors,
    this implementation applies the formulas to the HC3 coefficient,
    HC3 SE, and residual degrees of freedom. It is therefore
...
def build_ovb_summary(
    ...
    for key, effect in main_df.groupby(keys, dropna=False):
        ...
        rec.update({
            ...
            "sensitivity_inference_note": "partial-R2 OVB formulas applied to the HC3 estimate/SE and residual df",
        })
...
def main():
    ...
    print("=" * 100)
    print("CARRY · SINGLE-KPI DML · CARRY-ENDPOINT-REFERENCED CONFIGURATION")
    ...
    manifest = pd.DataFrame([{
        ...
        "ovb_inference_caveat": "Cinelli-Hazlett partial-R2 formulas applied to the HC3 coefficient/SE and residual df; observed benchmark strengths use linear projections while main nuisances remain nonlinear and cross-fitted",
