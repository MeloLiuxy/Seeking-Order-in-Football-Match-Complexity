# -*- coding: utf-8 -*-
"""
Carry · Rotating joint and interaction DML for the carry-endpoint-referenced configuration
===========================================================================
...
# Cluster-specific companion KPIs for the carry-endpoint-referenced configuration.
JOINT_ANCHOR_BY_CLUSTER_STAGE = {
    (0, "E'"): {
        "local_advantage": "Adv_10(E')",
        "distance_centroid": "Avg_3_Def(E')",
        "structure_shape": "Area_Def(E')",
    },
    (1, "E'"): {
        "local_advantage": "Adv_5(E')",
        "distance_centroid": "Avg_3_Def(E')",
        "structure_shape": "Area_Def(E')",
    },
    (2, "E'"): {
...
def joint_main():
    ...
    print("=" * 110)
    print("CARRY · ROTATING JOINT DML · CARRY-ENDPOINT-REFERENCED CONFIGURATION")
    print(f"Input : {INPUT_PATH}")
    print(f"Output: {OUTPUT_XLSX}")
    print("=" * 110)
