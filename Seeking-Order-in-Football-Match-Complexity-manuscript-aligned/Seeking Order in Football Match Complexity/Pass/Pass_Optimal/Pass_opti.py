...
def select_main_kpis(candidate_pool: pd.DataFrame) -> Tuple[Dict[int, List[str]], pd.DataFrame]:
    ...
    for cluster in sorted(pd.unique(candidate_pool["cluster"])):
        ...
        for family in EXPECTED_FAMILIES:
            ...
            family_rows["abs_single_effect"] = pd.to_numeric(family_rows["single_effect_per_1sd"], errors="coerce").abs()
...
def parse_args():
    ...
    parser.add_argument(
        ...
        default="strict",
        help=(
            "For --stage L/both: strict (default) uses the manuscript-table "
